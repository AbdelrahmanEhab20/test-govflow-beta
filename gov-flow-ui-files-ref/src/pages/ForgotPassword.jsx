  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 text-center">Forgot password</h1>
        <p className="text-slate-500 dark:text-slate-300 text-center mt-2 mb-6">We will send a reset link to your email.</p>
