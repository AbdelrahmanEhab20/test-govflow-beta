      ...
      <div className={`flex-1 p-6 lg:p-8 space-y-6 transition-all duration-300 ${aiPanelOpen ? 'mr-[420px]' : ''}`}>
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Team Performance Dashboard</h1>
              <p className="text-slate-500 dark:text-slate-300 mt-1">Analytics and insights into team productivity</p>
            </div>
          </div>
