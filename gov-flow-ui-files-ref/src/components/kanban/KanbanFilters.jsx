...
export default function KanbanFilters({ filters, onFiltersChange, users, ownTasksOnly = false }) {
  return (
    <Card className="dark:bg-slate-800 dark:border-slate-700">
      <CardContent className="pt-6">
        <div className={`grid grid-cols-1 gap-4 ${ownTasksOnly ? 'md:grid-cols-1' : 'md:grid-cols-3'}`}>
          {/* Assignee Filter */}
          {!ownTasksOnly && (
          <div>
